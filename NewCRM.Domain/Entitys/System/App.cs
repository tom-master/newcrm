		...
		public AppAuditState AppAuditState
		{
			...
			private set
			{
				if (_appAuditState != value)
				{
					...
					OnPropertyChanged("AppAuditState");
				}
			}
		}
		...
		public AppReleaseState AppReleaseState
		{
			...
			private set
			{
				if (_appReleaseState != value)
				{
					...
					OnPropertyChanged("AppReleaseState");
				}
			}
		}
