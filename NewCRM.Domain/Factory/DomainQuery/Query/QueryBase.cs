...
namespace NewCRM.Domain.Factory.DomainQuery.Query
{
    ...
    {
        public virtual U FindOne<T, U>(Specification<T> specification, Expression<Func<T, U>> selector) where T : DomainModelBase, IAggregationRoot
        {
            return default(U);
        }
        ...
        public virtual IEnumerable<U> PageBy<T, U>(Specification<T> specification, Int32 pageIndex, Int32 pageSize, out Int32 totalCount, Expression<Func<T, U>> selector) where T : DomainModelBase, IAggregationRoot
        {
            totalCount = 0;
            return default(IEnumerable<U>);
        }
