    ...
    return {
		...
		*/
        get: function () {
            ...
            HROS.request.get('/Index/GetAccountDeskMembers', {}, function (responseText) {
                if (responseText.IsSuccess) {
...
HROS.base = (function () {
    return {
		...
		*/
        ...
        logout: function () {
            HROS.request.post('/Index/Logout', {}, function (responseText) {
                location.reload();
            })
        },
        checkLogin: function () {
        ...
        getSkin: function (objSkin, callback) {
            if (objSkin === undefined) {
                HROS.request.get('/Index/GetSkin', {}, function (responseText) {
                    if (responseText.IsSuccess) {
    ...
    return {
		...
		*/
        ...
        getPos: function (callback) {
            HROS.request.get('/Index/GetDockPos', {}, function (responseText) {
                if (responseText.IsSuccess) {
    ...
    return {
        init: function () {
            ...
            $('body').on('click', '#lockbtn', function () {
                if ($('#lockpassword').val() !== '') {
                    HROS.request.post('/Index/UnlockScreen', { unlockPassword: $('#lockpassword').val() }, function (responseText) {
                        if (responseText.IsSuccess) {
                            HROS.lock.hide();
                        } else {
                            $('#lockpassword').val('').focus();
...
HROS.startmenu = (function () {
    return {
		...
		*/
        getAvatar: function () {
            HROS.request.get('/Index/GetAccountFace', {}, function (responseText) {
                if (responseText.IsSuccess) {
    ...
    return {
		...
		*/
        get: function (callback) {
            HROS.request.get('/Index/GetWallpaper', {}, function (responseText) {
                if (responseText.IsSuccess) {
		...
		*/
        create: function (realappid, type) {
            ...
            if (!iswindowopen && $('#d_' + realappid).attr('opening') != 1) {
                ...
                HROS.request.get('/Index/CreateWindow', { id: realappid, type: type }, function (responseText) {
                    if (responseText.IsSuccess) {
    ...
    return {
        ...
        internalRequset: function (url, method, parameter, callback) {  
            $.ajax({
                ...
                url: url,
                dataType: 'json',
                data: Object.keys(parameter).length ? JSON.stringify(parameter) : null,
                beforeSend: function () {
