    ...
    return {
		...
		*/
        updateXY: function (i) {
            if (HROS.CONFIG.appXY !== i) {
                if (HROS.base.checkLogin()) {
                    HORS.request.post('/DeskOptions/ModifyAppXy', { appXy: i }, function (responseText) {
                        if (responseText.IsSuccess) {
		...
		*/
        updateSize: function (i) {
            if (HROS.CONFIG.appSize !== i) {
                ...
                HROS.deskTop.resize();
                if (HROS.base.checkLogin()) {
                    HORS.request.post('/DeskOptions/ModifyAppSize', { appSize: i }, function (responseText) {
                        if (responseText.IsSuccess) {
		...
		*/
        updateVertical: function (i) {
            if (HROS.CONFIG.appVerticalSpacing != i) {
                ...
                HROS.deskTop.resize();
                if (HROS.base.checkLogin()) {
                    HORS.request.post('/DeskOptions/ModifyAppVertical', { appVertical: i }, function (responseText) {
                        if (responseText.IsSuccess) {
		...
		*/
        updateHorizontal: function (i) {
            if (HROS.CONFIG.appHorizontalSpacing != i) {
                ...
                HROS.deskTop.resize();
                if (HROS.base.checkLogin()) {
                    HORS.request.post('/DeskOptions/ModifyAppHorizontal', { appHorizontal: i }, function (responseText) {
                        if (responseText.IsSuccess) {
		...
		*/
        get: function () {
            ...
            HORS.request.get('/Index/GetAccountDeskMembers', {}, function (responseText) {
                if (responseText.IsSuccess) {
		...
		*/
        add: function (id, callback) {
            ...
            if (HROS.base.checkLogin()) {
                HORS.request.post('/AppMarket/InstallApp', { appId: id, deskNum: HROS.CONFIG.desk }, function (responseText) {
                    if (responseText.IsSuccess) {
                        done();
                    } else {
		...
		*/
        remove: function (id, callback) {
            ...
            if (HROS.base.checkLogin()) {
                HORS.request.post('/Desk/UninstallMember', { memberId: parseInt(id) }, function (responseText) {
                    if (responseText.IsSuccess) {
                        done();
                                ...
                                if (HROS.base.checkLogin()) {
                                    if (!HROS.app.checkIsMoving()) {
                                        if (HROS.app.dataDockToFolder(id, from, to)) {
                                            HORS.request.post('/Desk/MemberMove', { moveType: 'dock-folder', memberId: id, from: from, to: to }, function (responseText) {
                                                if (responseText.IsSuccess) {
                                                    HROS.VAR.isAppMoving = false;
                                                } else {
                                                    ZENG.msgbox.fail(responseText.Message);
                                    ...
                                    if (HROS.base.checkLogin()) {
                                        if (!HROS.app.checkIsMoving()) {
                                            if (HROS.app.dataDockToDesk(id, from, to, boa, desk)) {
                                                HORS.request.post('/Desk/MemberMove', { moveType: 'dock-desk', memberId: id, from: from, to: desk }, function (responseText) {
                                                    if (responseText.IsSuccess) {
                                                        HROS.VAR.isAppMoving = false;
                                                    } else {
                                                        ZENG.msgbox.fail(responseText.Message);
                                ...
                                if (HROS.base.checkLogin()) {
                                    if (!HROS.app.checkIsMoving()) {
                                        if (HROS.app.dataDeskToFolder(id, from, to, desk)) {
                                            HORS.request.post('/Desk/MemberMove', { moveType: 'desk-folder', memberId: id, from: from, to: to }, function (responseText) {
                                                if (responseText.IsSuccess) {
                                                    HROS.VAR.isAppMoving = false;
                                                } else {
                                                    ZENG.msgbox.fail(responseText.Message);
                                ...
                                if (HROS.base.checkLogin()) {
                                    if (!HROS.app.checkIsMoving()) {
                                        if (HROS.app.dataDeskToDock(id, from, to, boa, desk)) {
                                            HORS.request.post('/Desk/MemberMove', { moveType: 'desk-dock', memberId: id, from: from, to: to }, function (responseText) {
                                                if (responseText.IsSuccess) {
                                                    HROS.VAR.isAppMoving = false;
                                                } else {
                                                    ZENG.msgbox.fail(responseText.Message);
                                ...
                                if (HROS.base.checkLogin()) {
                                    if (!HROS.app.checkIsMoving()) {
                                        if (HROS.app.dataFolderToFolder(id, from, to, fromFolderId)) {
                                            HORS.request.post('/Desk/MemberMove', { moveType: 'folder-folder', memberId: id, from: from, to: to }, function (responseText) {
                                                if (responseText.IsSuccess) {
                                                    HROS.VAR.isAppMoving = false;
                                                } else {
                                                    ZENG.msgbox.fail(responseText.Message);
                                ...
                                if (HROS.base.checkLogin()) {
                                    if (!HROS.app.checkIsMoving()) {
                                        if (HROS.app.dataFolderToDock(id, from, to, fromFolderId, boa, desk)) {
                                            HORS.request.post('/Desk/MemberMove', { moveType: 'folder-dock', memberId: id, from: from, to: to }, function (responseText) {
                                                if (responseText.IsSuccess) {
                                                    HROS.VAR.isAppMoving = false;
                                                } else {
                                                    ZENG.msgbox.fail(responseText.Message);
                                    ...
                                    if (HROS.base.checkLogin()) {
                                        if (!HROS.app.checkIsMoving()) {
                                            if (HROS.app.dataFolderToDesk(id, from, to, fromFolderId, boa, desk)) {
                                                HORS.request.post('/Desk/MemberMove', { moveType: 'folder-desk', memberId: id, from: from, to: desk }, function (responseText) {
                                                    if (responseText.IsSuccess) {
                                                        HROS.VAR.isAppMoving = false;
                                                    } else {
                                                        ZENG.msgbox.fail(responseText.Message);
                                    ...
                                    if (HROS.base.checkLogin()) {
                                        if (!HROS.app.checkIsMoving()) {
                                            if (HROS.app.dataDeskToOtherdesk(id, from, to, boa, todesk, fromdesk)) {
                                                HORS.request.post('/Desk/MemberMove', { moveType: 'desk-desk', memberId: id, from: from, to: todesk }, function (responseText) {
                                                    if (responseText.IsSuccess) {
                                                        HROS.VAR.isAppMoving = false;
                                                    } else {
                                                        ZENG.msgbox.fail(responseText.Message);
...
HROS.base = (function () {
    return {
		...
		*/
        ...
        logout: function () {
            HORS.request.post('/Index/Logout', {}, function (responseText) {
                location.reload();
            })
        },
        checkLogin: function () {
        ...
        getSkin: function (objSkin, callback) {
            if (objSkin === undefined) {
                HORS.request.get('/Index/GetSkin', {}, function (responseText) {
                    if (responseText.IsSuccess) {
    ...
    return {
		...
		*/
        ...
        updateDefaultDesk: function (i) {
            if (HROS.base.checkLogin()) {
                HORS.request.post('/DeskOptions/ModifyDefaultDesk', { deskNum: i }, function (responseText) {
                    if (responseText.IsSuccess) {
        ...
        modifyWallpaperSource: function (value) {
            if (HROS.base.checkLogin()) {
                HORS.request.post('/DeskOptions/ModifyWallpaperSource', { source: value }, function (responseText) {
                    if (responseText.IsSuccess) {
    ...
    return {
		...
		*/
        ...
        updatePos: function (pos) {
            if (pos !== HROS.CONFIG.dockPos && typeof (pos) != 'undefined') {
                ...
                if (HROS.base.checkLogin()) {
                    HORS.request.post('/DeskOptions/ModifyDockPosition', { pos: pos, deskNum: HROS.CONFIG.desk }, function (responseText) {
                        if (responseText.IsSuccess) {
		...
		*/
        ...
        getPos: function (callback) {
            HORS.request.get('/Index/GetDockPos', {}, function (responseText) {
                if (responseText.IsSuccess) {
    ...
    return {
        init: function () {
            ...
            $('body').on('click', '#lockbtn', function () {
                if ($('#lockpassword').val() !== '') {
                    HORS.request.post('/Index/UnlockScreen', { unlockPassword: $('#lockpassword').val() }, function (responseText) {
                        if (responseText.IsSuccess) {
                            HROS.lock.hide();
                        } else {
                            $('#lockpassword').val('').focus();
                    ...
                    if (!HROS.app.checkIsMoving()) {
                        ...
                        if (obj.parent().hasClass('dock-applist')) {
                            ...
                            if (HROS.app.dataFolderToOtherdesk(id, from, todesk, fromfolderid)) {
                                HORS.request.post('/Desk/MemberMove', { moveType: 'folder-desk', memberId: id, from: from, to: todesk }, function (responseText) {
                                    if (responseText.IsSuccess) {
                                        HROS.VAR.isAppMoving = false;
                                    } else {
                                        ZENG.msgbox.fail(responseText.Message);
        ...
        papp: function (obj) {
            ...
            $('.papp-menu a[menu="moveto"]').off('click').on('click', function () {
                ...
                if (HROS.base.checkLogin()) {
                    ...
                    if (obj.parent().hasClass('dock-applist')) {
                        if (HROS.app.dataDockToOtherdesk(id, from, todesk)) {
                            HORS.request.post('/Desk/MemberMove', { moveType: 'dock-otherdesk', memberId: id, from: from, to: todesk }, function (responseText) {
                                if (responseText.IsSuccess) {
                                    HROS.VAR.isAppMoving = false;
                                } else {
                                    ZENG.msgbox.fail(responseText.Message);
            ...
            $('.folder-menu a[menu="rename"]').off('click').on('click', function () {
                if (HROS.base.checkLogin()) {
                    $.dialog({
                        ...
                        ok: function () {
                            if ($('#folderName').val() != '') {
                                HORS.request.post('/Desk/ModifyFolderInfo', { name: $('#folderName').val(), icon: $('.folderSelector img').attr('src'), memberId: parseInt(obj.attr('appid')) }, function (responseText) {
                                    if (responseText.IsSuccess) {
                                        HROS.app.get();
                                    }
                                })
                ...
                $('.desk-menu a[menu="addfolder"]').on('click', function () {
                    if (HROS.base.checkLogin()) {
                        $.dialog({
                            ...
                            ok: function () {
                                if ($('#folderName').val() != '') {
                                    HORS.request.post('/Desk/CreateNewFolder', {
...
HROS.startmenu = (function () {
    return {
		...
		*/
        getAvatar: function () {
            HORS.request.get('/Index/GetAccountFace', {}, function (responseText) {
                if (responseText.IsSuccess) {
    ...
    return {
		...
		*/
        get: function (callback) {
            HORS.request.get('/Index/GetWallpaper', {}, function (responseText) {
                if (responseText.IsSuccess) {
		...
		*/
        update: function (wallpaperShowType, wallpaperId) {
            ...
            if (HROS.base.checkLogin()) {
                if (wallpaperId === '') {
                    HORS.request.post('/DeskOptions/ModifyWallpaperDisplayModel', { wallPaperShowType: wallpaperShowType }, function (responseText) {
                        if (responseText.IsSuccess) {
                    ...
                    HORS.request.post('/DeskOptions/ModifyWallpaper', { wallpaperId: wallpaperId }, function (responseText) {
                        if (responseText.IsSuccess) {
		...
		*/
        create: function (realappid, type) {
            ...
            if (!iswindowopen && $('#d_' + realappid).attr('opening') != 1) {
                ...
                HORS.request.post('/Index/CreateWindow', { id: realappid, type: type }, function (responseText) {
