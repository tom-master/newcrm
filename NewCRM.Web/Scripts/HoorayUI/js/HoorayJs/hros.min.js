...
var editFolderDialogTemp = template.compile(
    ...
    '<a class="fcDropdown_item" title="默认"><img class="fcDropdown_img" src="/Scripts/HoorayUI/img/ui/folder_default.png"></a>' +
    '<a class="fcDropdown_item" title="文本"><img class="fcDropdown_img" src="/Scripts/HoorayUI/img/ui/folder_doc.png"></a>' +
    '<a class="fcDropdown_item" title="游戏"><img class="fcDropdown_img" src="/Scripts/HoorayUI/img/ui/folder_game.png"></a>' +
    '<a class="fcDropdown_item" title="生活"><img class="fcDropdown_img" src="/Scripts/HoorayUI/img/ui/folder_life.png"></a>' +
    '<a class="fcDropdown_item" title="音乐"><img class="fcDropdown_img" src="/Scripts/HoorayUI/img/ui/folder_music.png"></a>' +
    '<a class="fcDropdown_item" title="工具"><img class="fcDropdown_img" src="/Scripts/HoorayUI/img/ui/folder_tool.png"></a>' +
    '<a class="fcDropdown_item" title="视频"><img class="fcDropdown_img" src="/Scripts/HoorayUI/img/ui/folder_video.png"></a>' +
    '</div>' +
    '</div>'
);
//应用评分
    ...
    return {
                    ...
                    if (HROS.base.checkLogin()) {
                        ...
                        $.ajax({
                            ...
                            if (responseText.IsSuccess) {
                                ZENG.msgbox.success("打分成功！");
                            } else {
                                ZENG.msgbox.fail("你已经打过分了！");
                            }
                        });
                    } else {
                        HROS.base.login();
		...
		*/
        updateXY: function (i) {
            if (HROS.CONFIG.appXY !== i) {
                if (HROS.base.checkLogin()) {
                    $.post('/DeskOptions/ModifyAppXy', { appXy: i }, function (responseText) {
                        if (responseText.IsSuccess) {
                            HROS.CONFIG.appXY = i.toLowerCase();
                            HROS.deskTop.resize();
                            ZENG.msgbox.success('图标排列方向更新成功');
                        } else {
                            ZENG.msgbox.fail('图标排列方向更新失败');
                        }
                    });
                }
            }
		...
		*/
        updateSize: function (i) {
            if (HROS.CONFIG.appSize !== i) {
                ...
                HROS.deskTop.resize();
                if (HROS.base.checkLogin()) {
                    $.post('/DeskOptions/ModifyAppSize', { appSize: i }, function (responseText) {
                        if (responseText.IsSuccess) {
                            ZENG.msgbox.success('更新应用显示尺寸成功');
                        } else {
                            ZENG.msgbox.fail('更新应用显示尺寸失败');
                        }
                    });
                }
            }
		...
		*/
        updateVertical: function (i) {
            if (HROS.CONFIG.appVerticalSpacing != i) {
                ...
                HROS.deskTop.resize();
                if (HROS.base.checkLogin()) {
                    $.post('/DeskOptions/ModifyAppVertical', { appVertical: i }, function (responseText) {
                        if (responseText.IsSuccess) {
                            ZENG.msgbox.success('更新应用垂直间距成功');
                        } else {
                            ZENG.msgbox.fail('更新应用垂直间距失败');
                        }
                    });
                }
            }
		...
		*/
        updateHorizontal: function (i) {
            if (HROS.CONFIG.appHorizontalSpacing != i) {
                ...
                HROS.deskTop.resize();
                if (HROS.base.checkLogin()) {
                    $.post('/DeskOptions/ModifyAppHorizontal', { appHorizontal: i }, function (responseText) {
                        if (responseText.IsSuccess) {
                            ZENG.msgbox.success('更新应用水平间距成功');
                        } else {
                            ZENG.msgbox.fail('更新应用水平间距失败');
                        }
                    });
                }
            }
		...
		*/
        get: function () {
            ...
            $.get('/Index/GetAccountDeskMembers'/*, { deskId: parseInt(deskId) }*/, function (responseText) {
                if (responseText.IsSuccess) {
		...
		*/
        add: function (id, callback) {
            ...
            if (HROS.base.checkLogin()) {
                ...
                $.post('/AppMarket/InstallApp', { appId: id, deskNum: HROS.CONFIG.desk }, function (responseText) {
                    if (responseText.IsSuccess) {
                        done();
                    } else {
		...
		*/
        remove: function (id, callback) {
            ...
            if (HROS.base.checkLogin()) {
                $.post('/Desk/UninstallMember', { memberId: parseInt(id) }, function (responseText) {
                    if (responseText.IsSuccess) {
                        done();
                        ZENG.msgbox.success('移除成功，刷新后查看')
                    } else {
                        ZENG.msgbox.fail(responseText.Message);
                    }
                })
                                ...
                                if (HROS.base.checkLogin()) {
                                    if (!HROS.app.checkIsMoving()) {
                                        if (HROS.app.dataDockToFolder(id, from, to)) {
                                            $.post('/Desk/MemberMove', { moveType: 'dock-folder', memberId: id, from: from, to: to }, function (responseText) {
                                                if (responseText.IsSuccess) {
                                                    HROS.VAR.isAppMoving = false;
                                                } else {
                                                    ZENG.msgbox.fail(responseText.Message);
                                    ...
                                    if (HROS.base.checkLogin()) {
                                        if (!HROS.app.checkIsMoving()) {
                                            if (HROS.app.dataDockToDesk(id, from, to, boa, desk)) {
                                                $.post('/Desk/MemberMove', { moveType: 'dock-desk', memberId: id, from: from, to: desk }, function (responseText) {
                                                    if (responseText.IsSuccess) {
                                                        HROS.VAR.isAppMoving = false;
                                                    } else {
                                                        ZENG.msgbox.fail(responseText.Message);
                                ...
                                if (HROS.base.checkLogin()) {
                                    if (!HROS.app.checkIsMoving()) {
                                        if (HROS.app.dataDeskToFolder(id, from, to, desk)) {
                                            $.post('/Desk/MemberMove', { moveType: 'desk-folder', memberId: id, from: from, to: to }, function (responseText) {
                                                if (responseText.IsSuccess) {
                                                    HROS.VAR.isAppMoving = false;
                                                } else {
                                                    ZENG.msgbox.fail(responseText.Message);
                                ...
                                if (HROS.base.checkLogin()) {
                                    if (!HROS.app.checkIsMoving()) {
                                        if (HROS.app.dataDeskToDock(id, from, to, boa, desk)) {
                                            $.post('/Desk/MemberMove', { moveType: 'desk-dock', memberId: id, from: from, to: to }, function (responseText) {
                                                if (responseText.IsSuccess) {
                                                    HROS.VAR.isAppMoving = false;
                                                } else {
                                                    ZENG.msgbox.fail(responseText.Message);
                                ...
                                if (HROS.base.checkLogin()) {
                                    if (!HROS.app.checkIsMoving()) {
                                        if (HROS.app.dataFolderToFolder(id, from, to, fromFolderId)) {
                                            $.post('/Desk/MemberMove', { moveType: 'folder-folder', memberId: id, from: from, to: to }, function (responseText) {
                                                if (responseText.IsSuccess) {
                                                    HROS.VAR.isAppMoving = false;
                                                } else {
                                                    ZENG.msgbox.fail(responseText.Message);
                                ...
                                if (HROS.base.checkLogin()) {
                                    if (!HROS.app.checkIsMoving()) {
                                        if (HROS.app.dataFolderToDock(id, from, to, fromFolderId, boa, desk)) {
                                            $.post('/Desk/MemberMove', { moveType: 'folder-dock', memberId: id, from: from, to: to }, function (responseText) {
                                                if (responseText.IsSuccess) {
                                                    HROS.VAR.isAppMoving = false;
                                                } else {
                                                    ZENG.msgbox.fail(responseText.Message);
                                    ...
                                    if (HROS.base.checkLogin()) {
                                        if (!HROS.app.checkIsMoving()) {
                                            if (HROS.app.dataFolderToDesk(id, from, to, fromFolderId, boa, desk)) {
                                                $.post('/Desk/MemberMove', { moveType: 'folder-desk', memberId: id, from: from, to: desk }, function (responseText) {
                                                    if (responseText.IsSuccess) {
                                                        HROS.VAR.isAppMoving = false;
                                                    } else {
                                                        ZENG.msgbox.fail(responseText.Message);
                                    ...
                                    if (HROS.base.checkLogin()) {
                                        if (!HROS.app.checkIsMoving()) {
                                            if (HROS.app.dataDeskToOtherdesk(id, from, to, boa, todesk, fromdesk)) {
                                                $.post('/Desk/MemberMove', { moveType: 'desk-desk', memberId: id, from: from, to: todesk }, function (responseText) {
                                                    if (responseText.IsSuccess) {
                                                        HROS.VAR.isAppMoving = false;
                                                    } else {
                                                        ZENG.msgbox.fail(responseText.Message);
...
HROS.base = (function () {
    return {
		...
		*/
        ...
        logout: function () {
            $.post('/Index/Logout', {}, function (responseText) {
                location.reload();
            })
        },
        checkLogin: function () {
        ...
        getSkin: function (objSkin, callback) {
            if (objSkin === undefined) {
                $.get('/Index/GetSkin', {}, function (responseText) {
                    if (responseText.IsSuccess) {
    ...
    return {
		...
		*/
        ...
        updateDefaultDesk: function (i) {
            if (HROS.base.checkLogin()) {
                $.post('/DeskOptions/ModifyDefaultDesk', { deskNum: i }, function (responseText) {
                    if (responseText.IsSuccess) {
                        ZENG.msgbox.success('默认桌面更新成功');
        ...
        modifyWallpaperSource: function (value) {
            if (HROS.base.checkLogin()) {
                $.post('/DeskOptions/ModifyWallpaperSource', { source: value }, function (responseText) {
                    if (responseText.IsSuccess) {
    ...
    return {
		...
		*/
        ...
        updatePos: function (pos) {
            if (pos !== HROS.CONFIG.dockPos && typeof (pos) != 'undefined') {
                ...
                if (HROS.base.checkLogin()) {
                    $.post('/DeskOptions/ModifyDockPosition', { pos: pos, deskNum: HROS.CONFIG.desk }, function (responseText) {
                        if (responseText.IsSuccess) {
                            ZENG.msgbox.success('应用码头位置更新成功');
                            //更新码头位置
                            HROS.dock.setPos();
                            //更新桌面应用
                            HROS.app.set();
                        } else {
                            ZENG.msgbox.fail('应用码头位置更新失败');
                        }
                    });
                }
            }
		...
		*/
        ...
        getPos: function (callback) {
            ...
            $.get('/Index/GetDockPos', {}, function (responseText) {
    ...
    return {
        init: function () {
            ...
            $('body').on('click', '#lockbtn', function () {
                if ($('#lockpassword').val() !== '') {
                    $.get('/Index/UnlockScreen', { unlockPassword: $('#lockpassword').val() }, function (responseText) {
                        if (responseText.IsSuccess) {
                            HROS.lock.hide();
                        } else {
                            $('#lockpassword').val('').focus();
        ...
        show: function () {
            if ($('#lock').length == 0) {
                if (!HROS.base.checkLogin()) {
                    ...
                    if ($.cookie('isfirstlock' + HROS.CONFIG.memberID) == null) {
                        $.cookie('isfirstlock' + HROS.CONFIG.memberID, 1);
                        $.dialog({
                            title: '温馨提示',
                            icon: 'warning',
                    ...
                    if (!HROS.app.checkIsMoving()) {
                        ...
                        if (obj.parent().hasClass('dock-applist')) {
                            ...
                            if (HROS.app.dataFolderToOtherdesk(id, from, todesk, fromfolderid)) {
                                $.post('/Desk/MemberMove', { moveType: 'folder-desk', memberId: id, from: from, to: todesk }, function (responseText) {
                                    if (responseText.IsSuccess) {
                                        HROS.VAR.isAppMoving = false;
                                    } else {
                                        ZENG.msgbox.fail(responseText.Message);
        ...
        papp: function (obj) {
            ...
            $('.papp-menu a[menu="moveto"]').off('click').on('click', function () {
                ...
                if (HROS.base.checkLogin()) {
                    ...
                    if (obj.parent().hasClass('dock-applist')) {
                        if (HROS.app.dataDockToOtherdesk(id, from, todesk)) {
                            $.post('/Desk/MemberMove', { moveType: 'dock-otherdesk', memberId: id, from: from, to: todesk }, function (responseText) {
                                if (responseText.IsSuccess) {
                                    HROS.VAR.isAppMoving = false;
                                } else {
                                    ZENG.msgbox.fail(responseText.Message);
            ...
            $('.folder-menu a[menu="rename"]').off('click').on('click', function () {
                if (HROS.base.checkLogin()) {
                    $.dialog({
                        ...
                        ok: function () {
                            if ($('#folderName').val() != '') {
                                $.post('/Desk/ModifyFolderInfo', { name: $('#folderName').val(), icon: $('.folderSelector img').attr('src'), memberId: parseInt(obj.attr('appid')) }, function (responseText) {
                                    if (responseText.IsSuccess) {
                                        HROS.app.get();
                                    }
                                })
                ...
                $('.desk-menu a[menu="addfolder"]').on('click', function () {
                    if (HROS.base.checkLogin()) {
                        $.dialog({
                            ...
                            content: editFolderDialogTemp({
                                'name': '新建文件夹',
                                'src': '/Scripts/HoorayUI/img/ui/folder_default.png'
                            }),
                            ok: function () {
                                if ($('#folderName').val() != '') {
                                    $.post('/Desk/CreateNewFolder', {
...
HROS.startmenu = (function () {
    return {
		...
		*/
        getAvatar: function () {
            $.get('/Index/GetAccountFace', {}, function (responseText) {
                if (responseText.IsSuccess) {
    ...
    return {
		...
		*/
        get: function (callback) {
            $.get('/Index/GetWallpaper', {}, function (responseText) {
                if (responseText.IsSuccess) {
		...
		*/
        update: function (wallpaperShowType, wallpaperId) {
            ...
            if (HROS.base.checkLogin()) {
                if (wallpaperId === '') {
                    $.post('/DeskOptions/ModifyWallpaperDisplayModel', { wallPaperShowType: wallpaperShowType }, function (responseText) {
                        if (responseText.IsSuccess) {
                            ZENG.msgbox.success("壁纸显示模式设置成功！")
                            done();
                        }
                    })
                } else {
                    $.post('/DeskOptions/ModifyWallpaper', { wallpaperId: wallpaperId }, function (responseText) {
                        if (responseText.IsSuccess) {
                            ZENG.msgbox.success("壁纸设置成功！")
                            done();
                        }
                    })
                }
		...
		*/
        ...
        create: function (appid, type, realappid) {
            ...
            if (!iswidgetopen && $('#d_' + appid).attr('opening') != 1) {
                ...
                ZENG.msgbox.loading('小挂件正在加载中，请耐心等待...');
                //待修改
                $.ajax({
		...
		*/
        create: function (realappid, type) {
            ...
            if (!iswindowopen && $('#d_' + realappid).attr('opening') != 1) {
                ...
                ZENG.msgbox.loading('应用正在加载中，请耐心等待...');
                $.post('/Index/CreateWindow', { id: realappid, type: type }, function (responseText) {
                    //ZENG.msgbox.hide();
                    if (responseText.IsSuccess) {
        ...
        handle: function () {
            ...
            $('#desk').on('dblclick', '.window-container .title-bar', function (e) {
                ...
                if (obj.attr('realappid') !== 0) {
                    ...
                    ZENG.msgbox.info('对不起，该应用没有任何详细介绍');
                }
