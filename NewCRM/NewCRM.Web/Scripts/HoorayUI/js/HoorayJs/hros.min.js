    ...
    return {
                    ...
                    if (HROS.base.checkLogin()) {
                        $.ajax({
                            ...
                            if (responseText) {
                                ...
                                ZENG.msgbox.show("你已经打过分了！", 5, 2000);
                            }
                        });
                    } else {
                        HROS.base.login();
		...
		*/
        get: function () {
            ...
            /*var deskId = HROS.CONFIG.realDeskId === 0 ? 1 : HROS.CONFIG.realDeskId;*/

            $.get('/Index/GetAccountDeskMembers'/*, { deskId: parseInt(deskId) }*/, function (responseText) {
                if (typeof responseText.app !== 'undefined') {
                    ...
                    if (typeof responseText === 'object') {
                        ...
                        $.each(responseText.app, function (k, v) {
                            ...
                            if (movegrid !== null) {
                                ...
                                if (HROS.base.checkLogin()) {
                                    if (!HROS.app.checkIsMoving()) {
                                        ...
                                        /*if (sessionStorage.getItem(id) === null) {
                                            var member = eval('HROS.VAR.desk' + desk);
                                            sessionStorage.setItem(id, JSON.stringify(member[from]));
                                        }*/
		...
		*/
        init: function () {
            ...
            $('#dock-bar .pagination').on('mousedown', function () {
                ...
                HROS.CONFIG.realDeskId = $(this).attr('data-realdeskid');
		...
		*/
        ...
        getPos: function (callback) {
            $.get('/Index/GetDockPos', {}, function (responseText) {
                if (typeof responseText.data !== 'undefined') {
                    HROS.CONFIG.dockPos = responseText.data;
                    if (typeof (callback) === 'function') {
                        callback && callback();
                    }
                }
		...
		*/
        getAvatar: function () {
            $.get('/Index/GetAccountFace', {}, function (responseText) {
                if (typeof responseText.data !== 'undefined') {
                    $('#startmenu-container .startmenu-avatar img').attr('src', responseText.data);
                }
            });
        },
        /*
            ...
            if (HROS.base.checkLogin()) {
                if (wallpaperId === '') {
                    $.post('/DeskOptions/ModifyWallpaperDisplayModel', { wallPaperShowType: wallpaperShowType }, function (responseText) {
                        if (typeof responseText.success !== 'undefined') {
                            ZENG.msgbox.show("壁纸显示模式设置成功！", 4, 2000)
                            done();
                        }
                    })
                } else {
                    $.post('/DeskOptions/ModifyWallpaper', { wallpaperId: wallpaperId }, function (responseText) {
                        if (typeof responseText.success !== 'undefined') {
                            ZENG.msgbox.show("壁纸设置成功！", 4, 2000)
                            done();
                        }
                    })
                }
		...
		*/
        ...
        create: function (appid, type, realappid) {
            ...
            if (!iswidgetopen && $('#d_' + appid).attr('opening') != 1) {
                ...
                ZENG.msgbox.show('小挂件正在加载中，请耐心等待...', 6, 8000);
                $.ajax({
		...
		*/
        create: function (realappid, type) {
            ...
            if (!iswindowopen && $('#d_' + realappid).attr('opening') != 1) {
                ...
                ZENG.msgbox.show('应用正在加载中，请耐心等待...', 6, 8000);
