    ...
    return {
		...
		*/
        updateXY: function (i) {
            if (HROS.CONFIG.appXY !== i) {
                if (HROS.base.checkLogin()) {
                    $.post('/DeskOptions/ChangeAppXy', { appXy: i }, function (result) {
		...
		*/
        updateSize: function (i) {
            if (HROS.CONFIG.appSize !== i) {
                ...
                HROS.deskTop.resize();
                if (HROS.base.checkLogin()) {
                    $.post('/DeskOptions/ChangeAppSize', { appSize: i }, function (result) {
		...
		*/
        updateVertical: function (i) {
            if (HROS.CONFIG.appVerticalSpacing != i) {
                ...
                HROS.deskTop.resize();
                if (HROS.base.checkLogin()) {
                    $.post('/DeskOptions/ChangeAppVertical', { appVertical: i }, function (result) {
		...
		*/
        updateHorizontal: function (i) {
            if (HROS.CONFIG.appHorizontalSpacing != i) {
                ...
                HROS.deskTop.resize();
                if (HROS.base.checkLogin()) {
                    $.post('/DeskOptions/ChangeAppHorizontal', { appHorizontal: i }, function (result) {
		...
		*/
        get: function () {
            ...
            $.get('/Index/GetMyApp', function (data) {
    ...
    return {
		...
		*/
        ...
        updateDefaultDesk: function (i) {
            if (HROS.base.checkLogin()) {
                $.post('/DeskOptions/ChangeDefaultDesk', { deskNum: i }, function (result) {
                    if (parseInt(result.data) === 1) {
		...
		*/
        ...
        updatePos: function (pos) {
            if (pos !== HROS.CONFIG.dockPos && typeof (pos) != 'undefined') {
                ...
                if (HROS.base.checkLogin()) {
                    $.post('/DeskOptions/ChangeDockPosition', { pos: pos, deskNum: HROS.CONFIG.desk }, function (result) {
                        if (parseInt(result.data) === 1) {
    ...
    return {
		...
		*/
        get: function (callback) {
            $.get('/Index/GetWallpaper', {}, function (result) {
		...
		*/
        update: function (wallpaperShowType, wallpaperId) {
            ...
            if (HROS.base.checkLogin()) {
                if (wallpaperId === '') {
                    $.get('/DeskOptions/ModifyWallpaperDisplayModel', { wallPaperShowType: wallpaperShowType }, function (responseText) {
                        done();
                    })
                } else {
                    $.get('/DeskOptions/ModifyWallpaper', { wallpaperId: wallpaperId }, function (responseText) {
                        done();
                    })
                }
            } else {
