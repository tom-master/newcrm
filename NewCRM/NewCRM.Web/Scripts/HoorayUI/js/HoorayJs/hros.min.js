                                ...
                                if (HROS.base.checkLogin()) {
                                    if (!HROS.app.checkIsMoving()) {
                                        ...
                                        if (HROS.app.dataDockToFolder(id, from, to)) {
                                            $.post('/PlatformSetting/MemberMove', { moveType: 'dock-folder', memberId: id, from: from, to: to }, function (responseText) {
                                                HROS.VAR.isAppMoving = false;
                                            })
                                        }
                                    }
                                    ...
                                    if (HROS.base.checkLogin()) {
                                        if (!HROS.app.checkIsMoving()) {
                                            if (HROS.app.dataDockToDesk(id, from, to, boa, desk)) {
                                                $.post('/PlatformSetting/MemberMove', { moveType: 'dock-desk', memberId: id, from: from, to: desk }, function (responseText) {
                                                    HROS.VAR.isAppMoving = false;
                                                })
                                            }
                                        }
                                ...
                                if (HROS.base.checkLogin()) {
                                    if (!HROS.app.checkIsMoving()) {
                                        if (HROS.app.dataDeskToFolder(id, from, to, desk)) {
                                            $.post('/PlatformSetting/MemberMove', { moveType: 'desk-folder', memberId: id, from: from, to: to }, function (responseText) {
                                                HROS.VAR.isAppMoving = false;
                                            })
                                        }
                                    }
                                ...
                                if (HROS.base.checkLogin()) {
                                    if (!HROS.app.checkIsMoving()) {
                                        if (HROS.app.dataDeskToDock(id, from, to, boa, desk)) {
                                            $.post('/PlatformSetting/MemberMove', { moveType: 'desk-dock', memberId: id, from: from, to: to }, function (responseText) {
                                                HROS.VAR.isAppMoving = false;
                                            })
                                        }
                                    }
                                ...
                                if (HROS.base.checkLogin()) {
                                    if (!HROS.app.checkIsMoving()) {
                                        if (HROS.app.dataFolderToFolder(id, from, to, fromFolderId)) {
                                            $.post('/PlatformSetting/MemberMove', { moveType: 'folder-folder', memberId: id, from: from, to: to }, function (responseText) {
                                                HROS.VAR.isAppMoving = false;
                                            })
                                        }
                                    }
                                ...
                                if (HROS.base.checkLogin()) {
                                    if (!HROS.app.checkIsMoving()) {
                                        if (HROS.app.dataFolderToDock(id, from, to, fromFolderId, boa, desk)) {
                                            $.post('/PlatformSetting/MemberMove', { moveType: 'folder-dock', memberId: id, from: from, to: to }, function (responseText) {
                                                HROS.VAR.isAppMoving = false;
                                            })
                                        }
                                    }
                                    ...
                                    if (HROS.base.checkLogin()) {
                                        if (!HROS.app.checkIsMoving()) {
                                            if (HROS.app.dataFolderToDesk(id, from, to, fromFolderId, boa, desk)) {
                                                $.post('/PlatformSetting/MemberMove', { moveType: 'folder-desk', memberId: id, from: from, to: to }, function (responseText) {
                                                    HROS.VAR.isAppMoving = false;
                                                })
                                            }
                                        }
                                    ...
                                    if (HROS.base.checkLogin()) {
                                        if (!HROS.app.checkIsMoving()) {
                                            if (HROS.app.dataDeskToOtherdesk(id, from, to, boa, todesk, fromdesk)) {
                                                $.post('/PlatformSetting/MemberMove', { moveType: 'desk-desk', memberId: id, from: from, to: todesk }, function (responseText) {
                                                    HROS.VAR.isAppMoving = false;
                                                })
                                            }
                                        }
    ...
    return {
		...
		*/
        update: function (wallpaperShowType, wallpaperId) {
            ...
            if (HROS.base.checkLogin()) {
                if (wallpaperId === '') {
                    $.get('/PlatformSetting/ModifyWallpaperDisplayModel', { wallPaperShowType: wallpaperShowType }, function (responseText) {
                        done();
                    })
                } else {
                    $.get('/PlatformSetting/ModifyWallpaper', { wallpaperId: wallpaperId }, function (responseText) {
                        done();
                    })
                }
            } else {
