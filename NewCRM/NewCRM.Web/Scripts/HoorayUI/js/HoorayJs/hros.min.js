    ...
    return {
		...
		*/
        get: function () {
            ...
            $.get('/Index/GetMyApp', function (responseText) {
		...
		*/
        set: function () {
            ...
            for (var j = 1; j <= HROS.CONFIG.deskCount; j++) {
                ...
                if (typeof desk.deskMember !== 'undefined' && desk !== '') {
                    $(desk.deskMember).each(function () {
		...
		*/
        ...
        dataDockToDesk: function (id, from, to, boa, desk) {
            var rtn = false;
            desk = eval('HROS.VAR.desk' + desk).deskMember;
            if (HROS.VAR.dock[from] !== null) {
                if (to === 0) {
                    if (boa === 'b') {
        ...
        dataDockToOtherdesk: function (id, from, todesk) {
            var rtn = false;
            todesk = eval('HROS.VAR.desk' + todesk).deskMember;
            if (HROS.VAR.dock[from] !== null) {
        ...
        dataDeskToOtherdesk: function (id, from, to, boa, todesk, fromdesk) {
            ...
            var rtn = false;
            fromdesk = eval('HROS.VAR.desk' + fromdesk).deskMember;
            todesk = eval('HROS.VAR.desk' + todesk).deskMember;
        ...
        dataAllDockToDesk: function (desk) {
            desk = eval('HROS.VAR.desk' + desk).deskMember;
            $(HROS.VAR.dock).each(function (i) {
                desk.deskMember.push(HROS.VAR.dock[i]);
            });
        ...
        dataDeleteByAppid: function (appid) {
            ...
            for (var i = 1; i <= 5; i++) {
                ...
                var desk = eval('HROS.VAR.desk' + i).deskMember;
		...
		*/
        ...
        set: function () {
            ...
            for (var j = 0; j < HROS.CONFIG.deskCount; j++) {
                var desk_append = '', desk = eval('HROS.VAR.desk' + (j + 1)).deskMember;
                if (desk !== '') {
...
HROS.startmenu = (function () {
    return {
		...
		*/
        getAvatar: function () {
            $.get('/Index/GetUserFace', {}, function (responseText) {
                if (typeof responseText.data!=='undefined') {
                    ...
                    if (widget != null) {
                        if (widget['error'] == 'ERROR_NOT_FOUND') {
                            ...
                            HROS.window.createTemp({
                                appid: 'hoorayos-yysc',
                                title: '大资本市场',
                                url: 'sysapp/appmarket/index.php?id=' + (realappid == null ? $('#d_' +
