        ...
        get: function () {
            ...
            $.get('/Index/GetMyApp', function (data) {
                ...
                if (typeof data === 'object') {
                    ...
                    if (typeof data.app.Data.docks === 'object') {
                        HROS.VAR.dock = data.app.Data.docks;
                    }

                    var desks = data.app.Data.deskMembers;
                    ...
                    for (var i = 0; i < HROS.CONFIG.deskCount; i++) {
                        ...
                        if (typeof desk === 'object' && desk.deskName === 'Desk1') {
                            HROS.VAR.desk1 = desk;
                        }
                        if (typeof desk === 'object' && desk.deskName === 'Desk2') {
                            HROS.VAR.desk2 = desk;
                        }
                        if (typeof desk === 'object' && desk.deskName === 'Desk3') {
                            HROS.VAR.desk3 = desk;
                        }
                        if (typeof desk === 'object' && desk.deskName === 'Desk4') {
                            HROS.VAR.desk4 = desk;
                        }
                        if (typeof desk === 'object' && desk.deskName === 'Desk5') {
                            HROS.VAR.desk5 = desk;
                        }
                        if (typeof desk === 'object' && desk.deskName === 'Desk6') {
                            HROS.VAR.desk6 = desk;
                        }
                        if (typeof desk === 'object' && desk.deskName === 'Desk7') {
                            HROS.VAR.desk7 = desk;
                        }
                        if (typeof desk === 'object' && desk.deskName === 'Desk8') {
                            HROS.VAR.desk8 = desk;
                        }
                        if (typeof desk === 'object' && desk.deskName === 'Desk9') {
                            HROS.VAR.desk9 = desk;
                        }
                        if (typeof desk === 'object' && desk.deskName === 'Desk10') {
                            HROS.VAR.desk10 = desk;
                        }

                    }

                    if (typeof data.app.Data.folders === 'object') {
                        HROS.VAR.folder = data.app.Data.folders;
                    }
                }
                //输出桌面应用
                HROS.app.set();
		...
		*/
        get: function (callback) {
            $.get('/Index/GetWallpaper', { __: Date.now() }, function (result) {
                ...
                HROS.CONFIG.wallpaperState = values.Wallpaper.Source;
                switch (HROS.CONFIG.wallpaperState) {
                    case "自定义":
                    case "系统":
                        HROS.CONFIG.wallpaper = values.Wallpaper.Url;
                        HROS.CONFIG.wallpaperType = values.WallpaperShowType;
                        HROS.CONFIG.wallpaperWidth = values.Wallpaper.Width;
                        HROS.CONFIG.wallpaperHeight = values.Wallpaper.Heigth;
                        break;
                    case "网络":
                        HROS.CONFIG.wallpaper = values.Wallpaper.Url;
                        break;
