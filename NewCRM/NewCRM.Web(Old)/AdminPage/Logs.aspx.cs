...
namespace NewCRM.Web.AdminPage
{
    ...
    {
        private static readonly ILogBll Log = CreatefactoryBll.CreateLogBll();
        ...
        {
            PowerHelper.CheckPowerWithButton(ConstString.CheckPowerWithControl.CoreLogDelete,btnDeleteSelected);
        ...
        {
            //检查权限
            PowerHelper.CheckPowerWithLinkButtonField(ConstString.CheckPowerWithControl.CoreLogDelete,Grid1,"deleteField");
        }
        ...
        {
            if (!PowerHelper.CheckPower(ConstString.CheckPowerWithControl.CoreLogDelete))
            {
