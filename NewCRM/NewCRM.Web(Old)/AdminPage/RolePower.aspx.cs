...
namespace NewCRM.Web.AdminPage
{
    ...
    {
        private static readonly IRolePowerBll RolePowers = CreatefactoryBll.CreateRolePowerBll();
        ...
        {
            if (!PowerHelper.CheckPower(ConstString.CheckPowerWithControl.CoreRolePowerEdit))
            {
