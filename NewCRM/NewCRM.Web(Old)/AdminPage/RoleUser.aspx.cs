...
namespace NewCRM.Web.AdminPage
{
    ...
    {
        private static readonly IRoleUserBll RoleUsers = CreatefactoryBll.CreateRoleUserBll();
        ...
        {
            PowerHelper.CheckPowerWithButton(ConstString.CheckPowerWithControl.CoreRoleUserNew, btnNew);
            PowerHelper.CheckPowerWithButton(ConstString.CheckPowerWithControl.CoreRoleUserDelete,
                btnDeleteSelected);
        ...
        {
            PowerHelper.CheckPowerWithLinkButtonField(ConstString.CheckPowerWithControl.CoreRoleUserDelete,
                Grid2, "deleteField");
        }
        ...
        {
            if (!PowerHelper.CheckPower(ConstString.CheckPowerWithControl.CoreRoleUserDelete))
            {
