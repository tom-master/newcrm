...
namespace NewCRM.Web.AdminPage
{
    public partial class DeptUser :BasePage
    {
        ...
        private static readonly IDeptUserBll Dept = CreatefactoryBll.CreateDeptUserBll();
        ...
        {
            PowerHelper.CheckPowerWithButton(ConstString.CheckPowerWithControl.CoreDeptUserNew,btnNew);
            PowerHelper.CheckPowerWithButton(ConstString.CheckPowerWithControl.CoreDeptUserDelete, btnDeleteSelected);
        ...
        {
            List<Depts> depts = DeptHelper.Depts;
        ...
        {
            // 数据绑定之前，进行权限检查
            PowerHelper.CheckPowerWithLinkButtonField(ConstString.CheckPowerWithControl.CoreDeptUserDelete, Grid2, "deleteField");
        }
        ...
        {
            if (PowerHelper.CheckPower(ConstString.CheckPowerWithControl.CoreDeptUserDelete))
            {
