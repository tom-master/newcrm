<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeptEdit.aspx.cs" Inherits="NewCRM.Web.AdminPage.DeptEdit" %>
            ...
            <Items>
                <f:SimpleForm ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="10px" Title="SimpleForm">
                    <Items>
                        ...
                        <f:DropDownList ID="ddlParent" Label="上级部门" Required="true" ShowRedStar="true" runat="server">
                        </f:DropDownList>
