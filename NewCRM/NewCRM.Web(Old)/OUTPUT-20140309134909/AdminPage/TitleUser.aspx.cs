...
namespace NewCRM.Web.AdminPage
{
    ...
    {
        private static readonly ITitleUserBll TitleUsers = Createfactory.CreatefactoryBll.CreateTitleUserBll();
        ...
        {
            HelperCode.PowerHelper.CheckPowerWithButton(Conststring.CheckPowerWithControl.CoreTitleUserNew, btnNew);
            HelperCode.PowerHelper.CheckPowerWithButton(Conststring.CheckPowerWithControl.CoreTitleUserDelete,
                btnDeleteSelected);
        ...
        {
            HelperCode.PowerHelper.CheckPowerWithLinkButtonField(Conststring.CheckPowerWithControl.CoreTitleUserDelete,
                Grid2, "deleteField");
        }
        ...
        {
            if (!HelperCode.PowerHelper.CheckPower(Conststring.CheckPowerWithControl.CoreTitleUserDelete))
            {
