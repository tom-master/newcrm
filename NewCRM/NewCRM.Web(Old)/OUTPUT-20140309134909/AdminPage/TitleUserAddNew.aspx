<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TitleUserAddNew.aspx.cs" Inherits="NewCRM.Web.AdminPage.TitleUserAddNew" %>
...
<body>
    ...
    <f:Panel ID="Panel1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="5px" Layout="Fit">
        <Toolbars>
            <f:Toolbar ID="Toolbar1" runat="server">
                <Items>
                    ...
                    <f:TwinTriggerBox ID="ttbSearchMessage" Width="180px" runat="server" ShowLabel="false" EmptyText="在用户名称中搜索" Trigger1Icon="Clear" Trigger2Icon="Search" ShowTrigger1="false" OnTrigger2Click="ttbSearchMessage_Trigger2Click" OnTrigger1Click="ttbSearchMessage_Trigger1Click">
                    </f:TwinTriggerBox>
                </Items>
            </f:Toolbar>
        </Toolbars>
