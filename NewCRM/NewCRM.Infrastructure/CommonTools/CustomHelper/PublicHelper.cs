...
namespace NewCRM.Infrastructure.CommonTools.CustomHelper
{
    ...
    public static class PublicHelper
    {
        ...
        public static void VaildateArgument(object arg, string argName, bool canZero = false)
        {
            if (arg == null)
            {
        ...
        internal static ComponentException ThrowComponentException(string msg, Exception e = null)
        {
        ...
        /// <param name="msg"> 自定义异常消息 </param>
        /// <param name="e"> 实际引发异常的异常实例 </param>
        internal static RepositoryException ThrowDataAccessException(string msg, Exception e = null)
        {
            if (string.IsNullOrEmpty(msg) && e != null)
            {
                msg = e.Message;
            ...
            return e == null
                ? new RepositoryException(string.Format("数据访问层异常：{0}", msg))
                : new RepositoryException(string.Format("数据访问层异常：{0}", msg), e);
        }
        ...
        /// <param name="msg"> 自定义异常消息 </param>
        /// <param name="e"> 实际引发异常的异常实例 </param>
        internal static BusinessException ThrowBusinessException(string msg, Exception e = null)
        {
            if (string.IsNullOrEmpty(msg) && e != null)
            {
                msg = e.Message;
