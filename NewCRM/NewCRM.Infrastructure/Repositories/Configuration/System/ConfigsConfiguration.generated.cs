...
namespace NewCRM.Repositories.Configurations
{
    ...
    /// 实体类-数据表映射——系统配置
    /// </summary>    
    internal partial class ConfigsConfiguration : EntityTypeConfiguration<Configs>, IEntityMapper
    {
        /// <summary>
        /// 实体类-数据表映射构造函数——系统配置
        /// </summary>
        public ConfigsConfiguration()
        {
            ConfigsConfigurationAppend();
        }
        
        /// <summary>
        /// 额外的数据映射
        /// </summary>
        partial void ConfigsConfigurationAppend();
