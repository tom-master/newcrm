...
namespace NewCRM.Infrastructure.Repositories.Configurations
{
    ...
    /// 实体类-数据表映射——桌面成员
    /// </summary>    
    internal partial class DeskMemberConfiguration : EntityTypeConfiguration<DeskMember>, IEntityMapper
    {
        /// <summary>
        /// 实体类-数据表映射构造函数——桌面成员
        /// </summary>
        public DeskMemberConfiguration()
        {
            DeskMemberConfigurationAppend();
        }
        
        /// <summary>
        /// 额外的数据映射
        /// </summary>
        partial void DeskMemberConfigurationAppend();
