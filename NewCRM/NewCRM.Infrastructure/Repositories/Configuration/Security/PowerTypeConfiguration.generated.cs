...
namespace NewCRM.Infrastructure.Repositories.Configurations
{
    ...
    /// 实体类-数据表映射——PowerType
    /// </summary>    
    internal partial class PowerTypeConfiguration : EntityTypeConfiguration<PowerType>, IEntityMapper
    {
        /// <summary>
        /// 实体类-数据表映射构造函数——PowerType
        /// </summary>
        public PowerTypeConfiguration()
        {
            PowerTypeConfigurationAppend();
        }
        
        /// <summary>
        /// 额外的数据映射
        /// </summary>
        partial void PowerTypeConfigurationAppend();
