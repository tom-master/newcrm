...
namespace NewCRM.Assembly.Data.Configurations
{
    ...
    /// 实体类-数据表映射——用户配置
    /// </summary>    
    internal partial class UserConfigConfiguration : EntityTypeConfiguration<Config>, IEntityMapper
    {
        /// <summary>
        /// 实体类-数据表映射构造函数——用户配置
        /// </summary>
        ...
        {
            UserConfigConfigurationAppend();
        }
        
        /// <summary>
        /// 额外的数据映射
        /// </summary>
        partial void UserConfigConfigurationAppend();
