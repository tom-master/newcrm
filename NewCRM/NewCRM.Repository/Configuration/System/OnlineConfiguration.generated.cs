...
namespace NewCRM.Assembly.Data.Configurations
{
    ...
    /// 实体类-数据表映射——在线人数
    /// </summary>    
    internal partial class OnlineConfiguration : EntityTypeConfiguration<Online>, IEntityMapper
    {
        /// <summary>
        /// 实体类-数据表映射构造函数——在线人数
        /// </summary>
        ...
        {
            OnlineConfigurationAppend();
        }
        
        /// <summary>
        /// 额外的数据映射
        /// </summary>
        partial void OnlineConfigurationAppend();
